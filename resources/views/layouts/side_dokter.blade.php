 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/')}}" class="brand-link">
      <img src="{{url('/')}}/logo/logoAs.png" alt="Simeuleu Tengah" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Simeuleu Tengah</span>
    </a>
